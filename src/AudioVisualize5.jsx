    ...
    useEffect(() => {
        ...
        musicPaths.forEach(async (path, index) => {
            if (!isCancelled) {
                ...
                icosphere.position = new Vector3(index * 6, 0, 0);
        ...
        engine.runRenderLoop(() => {
            ...
            spheres.current.forEach((sphere, i) => {
                if (sphere.analyser && sphere.isPlaying) {
                    ...
                    let icosphere = icospheres.current[i];
                    if (icosphere) {
                        //icosphere.position.y = lowFreqAverage / 255 * 10;//この動き結構いいかも。あとで見る
                        ...
                        icosphere.material.setFloat("u_red", lowFreqAverage / 255);
                        icosphere.material.setFloat("u_green", lowFreqAverage / 255);
                        icosphere.material.setFloat("u_blue", lowFreqAverage / 255);
